...
export const demoData: DashboardData = {
  ...
  todos: [
    { id: 't1', family_id: 'demo-family', title: 'Buy groceries', description: '', family_member_id: 'mom', due_date: toDateKey(now), priority: 'high', completed: false },
  ...
  settings: { id: 'demo-settings', family_id: 'demo-family', mode: 'light', accent_color: DEFAULT_PALETTE.primary, palette: DEFAULT_PALETTE, saved_palettes: [], default_view: 'month', first_day_of_week: 1, temperature_unit: 'c', weather_location: 'Almaty' },
};
