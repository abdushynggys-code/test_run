...
export function LandingPage() {
  return <main className="landing-page">
    ...
    <Benefits />
    <FeatureShowcase />
    <Reveal><section className="landing-steps"><p className="eyebrow">SIMPLE FROM DAY ONE</p><h2>Set up once. See everything.</h2><div><article><b>1</b><span><strong>Create your family</strong><small>One parent account controls the dashboard.</small></span></article><article><b>2</b><span><strong>Add profiles</strong><small>Give each person a name, photo, and color.</small></span></article><article><b>3</b><span><strong>Plan together</strong><small>Add events, reminders, and assigned tasks.</small></span></article></div></section></Reveal>
    <LandingHelp />
